    ...
    <div className="min-h-screen bg-earth-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link href="/admin/gold-price" className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow group">
            <GoldIcon className="w-12 h-12 text-earth-300 group-hover:text-gold-500 transition-colors mb-4" />
            <h3 className="font-serif text-xl font-semibold text-earth-800 mb-2">Altın Fiyatı Takibi</h3>
            <p className="text-earth-500 text-sm">Güncel altın fiyatını takip et ve ayarla.</p>
          </Link>

          <Link href="/admin/walkin" className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow group">
            <StoreIcon className="w-12 h-12 text-earth-300 group-hover:text-gold-500 transition-colors mb-4" />
            <h3 className="font-serif text-xl font-semibold text-earth-800 mb-2">Mağaza İçi Satış</h3>
            <p className="text-earth-500 text-sm">Walk-in müşteri için hızlı sipariş oluştur.</p>
          </Link>
        </div>
      </div>
    </div>
