          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-5">
                ...
                <div>
                  <h3 className="font-serif text-xl font-bold text-earth-800">AltınÇağ</h3>
                  <p className="text-[11px] text-earth-400 tracking-[0.2em] uppercase">Kuyumculuk</p>
                </div>
              </div>
              <p className="text-base text-earth-500 leading-relaxed mb-5">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="p-2.5 bg-earth-50 rounded-full text-earth-400 hover:text-gold-500 hover:bg-gold-50 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 bg-earth-50 rounded-full text-earth-400 hover:text-green-500 hover:bg-green-50 transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Kurumsal */}
            <div>
              <h4 className="font-serif text-base font-semibold text-earth-800 mb-5">Kurumsal</h4>
              <ul className="space-y-3">
                {footerLinks.kurumsal.map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-base text-earth-500 hover:text-gold-600 transition-colors">
                      {link.name}
                    </Link>
                  </li>
                ))}
            ...
            {/* Kategoriler */}
            <div>
              <h4 className="font-serif text-base font-semibold text-earth-800 mb-5">Kategoriler</h4>
              <ul className="space-y-3">
            ...
            {/* E-Bülten */}
            <div>
              <h4 className="font-serif text-base font-semibold text-earth-800 mb-5">E-Bülten</h4>
              <p className="text-base text-earth-500 mb-5">
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-3 bg-earth-50 border border-earth-200 rounded-sm
                             text-base text-earth-700 placeholder-earth-400
                             focus:outline-none focus:border-gold-500"
                  required
                />
                <button
                  type="submit"
                  className="w-full bg-gold-500 text-white px-4 py-3 rounded-sm text-base font-medium
