  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 flex flex-row gap-3">
      <a
        ...
        className="w-12 h-12 bg-earth-800 hover:bg-earth-700 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110"
